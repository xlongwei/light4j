...
/**
 * UrlConfigLoader share same configurations structure with UrlProviderImpl and
 * FileSystemProviderImpl.
 * 
 * <pre>
env
config_server_authorization=
config_server_client_truststore_location=
java
-Dlight-config-server-uri=https://git.xlongwei.com
 * </pre>
 * 
 * @author xlongwei
 *
