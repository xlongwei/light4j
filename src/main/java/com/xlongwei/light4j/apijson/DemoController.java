...
public class DemoController extends APIJSONController {
	 ...
	 * </pre>
	 */
	public JSONObject postVerify(String request) {
		JSONObject requestObject = null;
		int type;
		String phone;
		try {
		...
		//这里直接返回验证码，方便测试。实际上应该只返回成功信息，验证码通过短信发送
	 ...
	 * </pre>
	 */
	public JSONObject headVerify(String request) {
		JSONObject requestObject = null;
		int type;
		String phone;
		String verify;
	 ...
	 * </pre>
	 */
	public JSONObject register(String request) {
		JSONObject requestObject = null;
	 ...
	 * </pre>
	 */
	public JSONObject putPassword(String request){
		JSONObject requestObject = null;
		String oldPassword;
		String verify;
		...
		// 上线版加上   password = MD5Util.MD5(password);
	 ...
	 * </pre>
	 */
	public JSONObject putBalance(String request, HttpSession session) {
		JSONObject requestObject = null;
		JSONObject privacyObj;
		long userId;
		String payPassword;
